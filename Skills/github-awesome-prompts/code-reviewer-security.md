---
title: Revue de code orientée sécurité (OWASP)
keywords: sécurité, security, OWASP, vulnérabilité, XSS, injection, auth, crypto, review, audit
always: false
---

<!-- Source: awesome-prompts prompts/code_reviewer_security.txt -->
